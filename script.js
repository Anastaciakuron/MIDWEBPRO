...
const programs = {
  ...
  FFIL:['Ilmu Filsafat'],
  FKIP:['Pendidikan Agama','Pendidikan Bahasa Inggris','Pendidikan Ekonomi','Pendidikan Luar Sekolah'],
  FEB:['Akutansi','Manajemen'],
  pertanian:['Agroteknologi'],
  FIK:['Informatika','Sistem Informasi'],
  FKEP:['Profesi Ners','Keperawatan'],
  sekretari:['Sekretari (D3)']
}
